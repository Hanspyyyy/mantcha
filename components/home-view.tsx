    ...
    <div className="min-h-screen pt-20 pb-32 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
           Hai, Welcome to the world of Mantchaa💕
          </motion.h1>
        ...
        >
          <p className="text-pink-300/50 text-xs">
             Tap frame to see more photos • Shake phone to animate • Long press for 3s to reset • click anything to find out • |Desain by Hans.py | Kim|
          </p>
        </motion.div>
